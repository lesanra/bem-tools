...
exports.getBemTechPath = function(name, opts) {
    ...
    var bemLib = process.env.COVER? 'bem/lib-cov/' : 'bem/lib/',
        bemTechs = PATH.unixToOs(bemLib +
                                    (opts.version === 1 ? 'techs'
                                                        : 'techs/v2')),
    ...
    if (!opts.throwWhenUnresolved) return PATH.unixToOs(bemLib + 'tech');
...
exports.getDirsFilesSync = function(path, dirs, files) {
    ...
    items.forEach(function(item) {
        ...
        var stat = FS.statSync(path + PATH.dirSep + item),
            file = {
                file: item,
